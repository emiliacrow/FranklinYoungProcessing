...
class DuckworthWindow(QWidget):
    ...
    def is_testing_buttons(self):
        ...
        self.testing_button = QRadioButton('Aurora-Production')
    ...
    def ingestion_buttons(self,column_pos):
        ...
        self.ingestion_options = ['0-FyProduct Ingestion(1 step)','1-Minimum Product Ingestion(3 steps)','2-Full Product Ingestion(5 steps)','3-Fill Product Attributes(2 steps)','4-Minimum Product Price(3 steps)','5-Base Pricing(1 step)','GSA Pricing','VA Pricing', 'HTME Pricing','INTRAMALLS Pricing',
                                  'ECAT Pricing', 'FEDMALL Pricing']
    ...
    def contract_buttons(self,column_pos):
        self.contract_options = ['Update Toggles','Process Product Assets','Process Featured Product']
