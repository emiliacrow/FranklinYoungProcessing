...
class DalObject:
    ...
    def set_testing(self, is_testing):
        if is_testing:
            self.__host = 'sequoia-test-aurora-cluster.cluster-ctjmonskvld5.us-east-1.rds.amazonaws.com'
    ...
    def vendor_cap(self, newVendorCode, newVendorName, newVendorNotes = '', newBrandName='', newFOBOrigin = -1):
        proc_name = 'sequoia.Vendor_capture_wrap'
        proc_args = (newBrandName, newVendorCode, newVendorName, newVendorNotes, newFOBOrigin)
        return_id = self.id_cap(proc_name, proc_args)
        return return_id
    ...
    def gsa_product_price_insert(self,lst_gsa_product_price):
        proc_name = 'sequoia.GSAProductPrice_insert3'
    ...
    def gsa_product_price_update(self,lst_gsa_product_price):
        proc_name = 'sequoia.GSAProductPrice_update4'
    ...
    def get_gsa_price_lookup(self):
        ...
        column_names = ['FyProductNumber','VendorPartNumber','GSAOnContract', 'GSAApprovedListPrice',
    ...
    def va_product_price_insert(self, lst_va_product_price):
        proc_name = 'sequoia.VAProductPrice_insert3'
    ...
    def va_product_price_update(self, lst_va_product_price):
        proc_name = 'sequoia.VAProductPrice_update4'
    ...
    def get_va_price_lookup(self):
        ...
        column_names = ['FyProductNumber','VendorPartNumber','VAOnContract', 'VAApprovedListPrice',
    ...
    def min_product_price_insert(self,lst_product_price):
        proc_name = 'sequoia.MinimumProductPrice_insert6'
    ...
    def min_product_price_update(self,lst_product_price):
        proc_name = 'sequoia.MinimumProductPrice_update5'
    ...
    def min_product_price_nouoi_update(self,lst_product_price):
        proc_name = 'sequoia.MinimumProductPrice_nouoi_update5'
    ...
    def fy_product_description_insert(self, lst_descriptions):
        proc_name = 'sequoia.ProductDescription_insert13'
    ...
    def fy_product_description_contract_insert(self, lst_contract_descriptions):
        proc_name = 'sequoia.ProductDescription_contract_insert14'
    ...
    def set_fy_product_description(self, lst_descriptions):
        proc_name = 'sequoia.ProductDescription_update12'
    ...
    def get_productids(self):
        proc_name = 'sequoia.get_productids'
        column_names = ['ProductId', 'FyCatalogNumber']
        df_productids = self.get_lookup(proc_name,column_names)
        return df_productids
