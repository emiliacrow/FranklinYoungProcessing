...
class IngestionObject:
    ...
    def get_unit_of_issue(self, unit_of_issue_id):
        return_id = -1
        return_id = self.obDal.get_unit_of_issue(unit_of_issue_id)
        return return_id
    ...
    def ingest_product_price(self, is_last, newFyProductNumber,newAllowPurchases,newFyPartNumber,newProductTaxClass,newVendorPartNumber,newProductId,newVendorId,newUnitOfIssueId):
        if (len(self.product_collector) >= self.load_limit) or (is_last):
            self.product_collector.append([newFyProductNumber,newAllowPurchases,newFyPartNumber,newProductTaxClass,newVendorPartNumber,newProductId,newVendorId,newUnitOfIssueId])
    ...
    def ingest_base_price(self, is_last, vendor_list_price, fy_discount_percent, fy_cost, estimated_freight, fy_landed_cost, markup_percent_fy_sell, fy_sell_price, markup_percent_fy_list, fy_list_price, fy_list_price_variance, is_visible, date_catalog_recieved, mfc_discount_percent, mfc_price, product_price_id, newVAProductPriceId=-1, newGSAProductPriceId=-1, newHTMEProductPriceId=-1, newECATProductPriceId=-1, newFEDMALLProductPriceId=-1):
        if (len(self.product_collector) >= self.load_limit) or (is_last):
            self.product_collector.append(
                [vendor_list_price, fy_discount_percent, fy_cost, estimated_freight, fy_landed_cost,
                 ...
                 is_visible, date_catalog_recieved, mfc_discount_percent, mfc_price, product_price_id,
            ...
            self.product_collector.append([vendor_list_price, fy_discount_percent, fy_cost, estimated_freight, fy_landed_cost, markup_percent_fy_sell, fy_sell_price, markup_percent_fy_list, fy_list_price, fy_list_price_variance, is_visible, date_catalog_recieved, mfc_discount_percent, mfc_price, product_price_id, newVAProductPriceId, newGSAProductPriceId, newHTMEProductPriceId, newECATProductPriceId, newFEDMALLProductPriceId])
