...
class AssignCategoryDialog(QDialog):
    def __init__(self, new_description, lst_categories, parent=None, icon = 'duck'):
        ...
        self.layout.addWidget(self.category1_label, 2, 0, 1, 1)
        ...
        self.layout.addWidget(self.category1_dropdown, 2, 1, 1, 2)

        # second left-most catgegory label
        self.category2_label = QLabel('Category level 2: ')
        self.layout.addWidget(self.category2_label, 3, 0, 1, 1)

        # second right big drop down
        self.category2_dropdown = QComboBox()
        self.category2_dropdown.currentIndexChanged.connect(self.update_third_level)
        self.layout.addWidget(self.category2_dropdown, 3, 1, 1, 2)

        # second left-most catgegory label
        self.category3_label = QLabel('Category level 3: ')
        self.layout.addWidget(self.category3_label, 4, 0, 1, 1)

        # second right big drop down
        self.category3_dropdown = QComboBox()
        self.layout.addWidget(self.category3_dropdown, 4, 1, 1, 2)


        # attempt to accept the data
        self.assign_button = QPushButton('assign levels', self)
        ...
        self.layout.addWidget(self.assign_button, 4, 3, 1, 1)

        # second left-most catgegory label
        self.full_category_label = QLabel('Full Category: ')
        self.layout.addWidget(self.full_category_label, 5, 0, 1, 1)

        # second right big drop down
        self.full_category_dropdown = QComboBox()
        self.full_category_dropdown.addItems(lst_categories)
        self.layout.addWidget(self.full_category_dropdown, 5, 1, 1, 2)

        # attempt to accept the data
        self.take_full_button = QPushButton('take full category', self)
