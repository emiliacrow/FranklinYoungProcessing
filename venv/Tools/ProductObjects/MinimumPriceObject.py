        ...
        if str(row['Filter']) in ['Partial','ConfigurationChange','check_vendor']:
            if (unit_of_issue_symbol_id != -1) and (unit_of_measure_symbol_id != -1) and (unit_of_issue_quantity != -1):
                self.obIngester.insert_product_price(fy_product_number, fy_part_number,
                                                     ...
                                                     unit_of_issue_symbol_id, unit_of_measure_symbol_id, unit_of_issue_quantity, product_description_id, vendor_product_notes,is_discontinued, vendor_product_name, vendor_product_description, country_of_origin_id, minimum_order_qty)
            else:
            ...
            self.obIngester.update_product_price_nouoi(price_id, fy_product_number, fy_part_number,
                                                 product_tax_class, vendor_part_number, product_id, vendor_id,
                                                 product_description_id, vendor_product_notes,is_discontinued, vendor_product_name, vendor_product_description, country_of_origin_id, minimum_order_qty)
